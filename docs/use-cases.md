...
- Получатель не найден: Система возвращает `404 Not Found` или `400 Bad Request`, пользователь видит сообщение «Профиль не найден» или "Введите корректные данные." и может ввести данные вручную.
- Пользователь может повторно ввести данные или выбрать опцию "Подобрать подарок без профиля" (с ручным вводом интересов/тегов).
...
- Email уже существует: Система возвращает `409 Conflict` (аккаунт уже существует), отображает сообщение: "Аккаунт с таким email уже зарегистрирован.", система предлагает войти или восстановить пароль.
...
- Email не найден: Система возвращает `404 Not Found`, отображает сообщение: "Указанный email не найден. Попробуйте снова.", пользователь может повторно ввести email или перейти к регистрации.
